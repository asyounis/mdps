...
# Project Imports
from evaluators.metrics.translation_xy_mse import TranslationXYMSE


class TranslationXYRMSE (TranslationXYMSE):
    def __init__(self, name, configs):
        super(TranslationXYRMSE, self).__init__(name, configs)
